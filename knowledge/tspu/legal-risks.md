...
РКН использует автоматизированную систему "Ревизор" для мониторинга корректности работы ТСПУ у провайдеров. Система
проверяет доступность заблокированных ресурсов из сети провайдера.
...
Массовое использование бесплатных MTProto прокси создаёт значительную нагрузку на ТСПУ, что иногда приводит к сбоям в
работе DPI. Это побочный эффект, а не целенаправленный обход.
